...
const AboutUs = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <img src="https://www.dartdesignltd.co.uk/wp-content/uploads/2018/07/So_who_are_we.jpg" className="max-w-sm rounded-lg shadow-2xl image" />
    <div>
      <h1 className="text-4xl font-bold text-[#6A5ACD]">We are Team <span className="text-[#1584af]">Taskify</span></h1>
